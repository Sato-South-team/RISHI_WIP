...
namespace DATA_LAYER.DatabaseConnectivity
{
    public class DatabaseConnections
    {
        ...
        public bool Connect1()
        {
            try
            {
                strSqlConn = ConfigurationManager.AppSettings["MySqlConnection"].ToString();
        ...
        public DataTable FetchData(string Value)
        {
            try
            {
                Connect1();
                ...
                //con = new MySqlConnection(strSqlConn);
                mySql.Connection = con;
                MySqlDataAdapter sda = new MySqlDataAdapter(Value, con);
                mySql.CommandType = CommandType.Text;
                mySql.CommandText = Value;
